...
_G.packer_plugins = {
  ...
  ["indent-blankline.vim"] = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/indent-blankline.vim",
    url = "https://github.com/lukas-reineke/indent-blankline.vim"
  },
  ["lspkind-nvim"] = {
    loaded = true,
