...
_G.packer_plugins = {
  ...
  ["colorbuddy.nvim"] = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/colorbuddy.nvim",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["neosolarized.nvim"] = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/neosolarized.nvim",
